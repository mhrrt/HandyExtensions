...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Mhrrt/HandyExtensions'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mhrrt' => 'manishhtrivedi@gmail.com' }
  s.source           = { :git => 'https://github.com/Mhrrt/HandyExtensions.git', :tag => s.version.to_s }
